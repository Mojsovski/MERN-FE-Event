...
const InputFile = (props: IProps) => {
  ...
  return (
    <label
      ...
      className={cn(
        "my-5 flex min-h-24 w-full cursor-pointer flex-col items-center justify-center rounder-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100",
        className
      )}
    >
      {uploadedImage ? (
